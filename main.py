...
app = Flask(__name__)
# LINE BOT info
line_bot_api = LineBotApi('nOKcVIJwWyS2Xi1LF5apGUfG/oPlUC8SaVXjRnsMeL+EdPu7pDXUixtjwG+JSU4FCcXLl63sYFj6EqkNpEW8e4MvCdUjDcJtDJ3cJFKWg2KYjZLTBYncQXM5yM+NZ/ILlQpshHmIPOB3lFAwyWjUGwdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('869b85cef54fcebf42156c18f88fb1c1')
...
def get(city):
    url = 'https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWB-C61A529F-C4D3-499A-8DFC-D1C585AED84A'
